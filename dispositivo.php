  ...
  <div class="row align-items-stretch">
    <form action="./Controlador/registroDispositivo.php" method="POST" enctype="multipart/form-data">
      <section class="form-register">
        ...
        <div>
          <input class="btn btn-success" type="submit" value="Registrar"> <input class="btn btn-info" type="button" onclick="history.back()" name="volver atrás" value="Volver atrás">
        </div>
      </section>
    </form>
    <div>
